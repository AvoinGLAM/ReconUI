...
function generateComponentBody(viewType) {
    ...
    <div class="componentContent">
        <div>At the moment the settings cannot be changed. The idea is that the user could tweak the search settings for individual searches to limit or expand the search of candidates.</div>
        <h2>Data source</h2>
        ...
        <div class="propgrid grid-3">
            ...
            <div></div>
            <div class="rowcontent"><div class="bold-text">Wikibase</div>First only Wikidata will be searched.</div>
            <select id="serviceSelect">
                <option value="wikidata" selected>Wikidata</option>
            </select>

            <div></div>
            <div class="rowcontent"><div class="bold-text">Endpoint</div>Wikidata SPARQL endpoint uses mwapi to make a
            ...
            <div></div>
            <div class="rowcontent"><div class="bold-text">Language</div></div>
            ...
            <div class="grid-4 grid-span-2-2 propgrid">

                <div class="check">On/off</div>
                <div class="rowcontent">Wikibase property</div>
                <div class="rowcontent">Dataset value</div>
                <div class="rowcontent">Delete</div>
